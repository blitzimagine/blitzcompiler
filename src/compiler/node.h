...
struct Node
{
    ...
    static TNode* call(const string& func, TNode* a0 = nullptr, TNode* a1 = nullptr, TNode* a2 = nullptr);
    static TNode* fcall(const string& func, TNode* a0 = nullptr, TNode* a1 = nullptr, TNode* a2 = nullptr);
};

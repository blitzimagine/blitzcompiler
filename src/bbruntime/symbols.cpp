...
void runtime_link(LinkSymbol linkSymbol)
{
    linkSymbol("End");
    linkSymbol("Stop");
...
void basic_link(LinkSymbol linkSymbol)
{
...
void math_link(LinkSymbol linkSymbol)
{
...
void string_link(LinkSymbol linkSymbol)
{
...
void stream_link(LinkSymbol linkSymbol)
{
...
void sockets_link(LinkSymbol linkSymbol)
{
...
void filesystem_link(LinkSymbol linkSymbol)
{
...
void bank_link(LinkSymbol linkSymbol)
{
...
void graphics_link(LinkSymbol linkSymbol)
{
    //gfx driver info
...
void input_link(LinkSymbol linkSymbol)
{
...
void audio_link(LinkSymbol linkSymbol)
{
...
void multiplay_link(LinkSymbol linkSymbol)
{
...
void userlibs_link(LinkSymbol linkSymbol)
{
...
void blitz3d_link(LinkSymbol linkSymbol)
{
